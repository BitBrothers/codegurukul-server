angular.module('Codegurukul', ['ngResource', 'ngMessages', 'ui.router', 'mgcrea.ngStrap', 
                '720kb.socialshare','ngModal', 'ngSanitize','ngTagsInput','720kb.tooltips',
                /*'validation.match',*/'slick',/*'textAngular',*/'angularFileUpload'])
